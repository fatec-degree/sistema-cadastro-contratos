...
INSERT INTO contracts (service_provider_id, responsible_id, student_id, amount, first_parcel, collection_day, number_of_parcels, parcel_value, year, start, end, expired, file_data, status) VALUES
    (1, 1, 1, 1000.00, '2023-01-20', 20, 12, 83.35, 2023, '2022-12-20', '2023-12-20', FALSE, null, 'ATIVO'),
    (1, 1, 2, 1500.00, '2023-01-21', 20, 12, 125.0, 2023, '2022-12-21', '2023-12-21', FALSE, null, 'ATIVO'),
    (1, 1, 3, 2000.00, '2023-01-22', 5, 12, 166.70, 2023, '2022-12-22', '2023-12-22', FALSE, null, 'ATIVO'),
    (1, 2, 4, 2500.00, '2023-01-23', 20, 12, 208.35, 2023, '2022-12-23', '2023-12-23', FALSE, null, 'ATIVO'),
    (1, 3, 5, 3000.00, '2023-01-24', 20, 12, 250.0, 2023, '2022-12-24', '2023-12-24', FALSE, null, 'ATIVO'),
    (1, 4, 6, 3500.00, '2023-01-25', 5, 12, 291.70, 2023, '2022-12-25', '2023-12-25', FALSE, null, 'CANCELADO'),
    (1, 5, 7, 4000.00, '2023-01-26', 20, 12, 333.35, 2023, '2022-12-26', '2023-12-26', FALSE, null, 'AGUARDANDO_ASSINATURAS'),
    (1, 6, 8, 4500.00, '2023-01-27', 20, 12, 375.0, 2023, '2022-12-27', '2023-12-27', FALSE, null, 'AGUARDANDO_ASSINATURAS'),
    (1, 7, 9, 5000.00, '2023-01-28', 5, 12, 416.70, 2023, '2022-12-28', '2023-12-28', FALSE, null, 'CANCELADO'),
    (1, 8, 10, 5500.00, '2023-01-29', 5, 12, 458.35, 2023, '2022-12-29', '2023-12-29', FALSE, null, 'AGUARDANDO_ASSINATURAS'),
    (1, 9, 11, 6000.00, '2023-01-30', 5, 12, 500.0, 2023, '2022-12-30', '2023-12-30', FALSE, null, 'CANCELADO'),
    (1, 10, 12, 5500.00, '2023-01-20', 5, 12, 458.35, 2023, '2022-12-29', '2023-12-29', FALSE, null, 'CANCELADO'),
    (1, 11, 13, 5500.00, '2023-01-29', 20, 12, 458.35, 2023, '2022-01-01', '2023-01-01', FALSE, null, 'EXPIRADO'),
    (1, 12, 14, 5500.00, '2023-01-29', 20, 12, 458.35, 2023, '2022-12-29', '2023-12-29', FALSE, null, 'ATIVO'),
    (1, 13, 15, 5500.00, '2023-01-29', 20, 12, 458.35, 2023, '2022-12-29', '2023-12-29', FALSE, null, 'AGUARDANDO_ASSINATURAS');

...
public interface ContractRepository extends JpaRepository<Contract, Long> {
    ...
    @Query(value = "SELECT contr.id, stud.name as studentName, resp.name as responsibleName, schoo.name as schoolName, contr.start, contr.end, contr.amount, contr.year FROM contracts contr " +
